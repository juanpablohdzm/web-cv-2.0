                ...
                <div className={"container max-w-screen-xl mx-auto px-4"}>
                    ...
                    <div className="text-center">
                        ...
                        <p className="font-normal text-gray-600 text-md md:text-xl mb-16">
                            Passionate software engineer, with proficient
                            knowledge in Gameplay Programming, VR, AR, Software
                            Architecture, Blockchain, and Mobile Applications.
                        </p>
                    ...
                    <div className="flex flex-col lg:flex-row justify-between">
                        <div className="mb-10 lg:mb-0">
                            ...
                            <p className="font-normal text-gray-500 text-xs md:text-base">
                                Here are some examples of projects I have been
                                part of
                            </p>
                        </div>
                        ...
                        <div className="space-y-24">
                            <ProjectCard
                                ...
                                description={
                                    "Build the void is a serverless multiplayer game that allows users to create/modify their own world entirely on the Blockchain. The game is built with PlayCanvas and uses a L2 Ethereum blockchain to store the world data"
                                }
                            />
                            <ProjectCard
                                identifier={"02"}
                                ...
                                description={
                                    "Notification system created entirely in C++, exposed to BP using Unreal's reflection system. The system allows user to dynamically generate a notification body that can be received and used in any other system"
                                }
                            />
                            ...
                            <ProjectCard
                                ...
                                description={
                                    "Blockchain plugin created entirely in C++, exposed to BP using Unreal's. The system allows user to interact with the Ethereum blockchain"
                                }
                            />
                            <ProjectCard
                                identifier={"04"}
                                ...
                                description={
                                    "Couch is a multiplayer VR game that allows users to watch Youtube video togethers in a virtual session. Created with Unity and Photon for multiplayer networking"
                                }
                            />
                            <ProjectCard
                                identifier={"05"}
                                ...
                                description={
                                    "Nevermet is a mobile application that allows users to meet new people. Created with React Native and GraphQL for the backend"
                                }
                            />
                        </div>
                    </div>
                ...
                <div className="container max-w-screen-xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <ExperienceCard
                            company={"AppLayer"}
                            title={
                                "Unreal Engine C++/Blockchain Architecture Developer"
                            }
                        ...
                        <ExperienceCard
                            ...
                            videoUrls={[
                                "https://www.youtube.com/embed/yEFp-uGQplw?si=_k_kp2Sbdz5qO83t",
                                "https://www.youtube.com/embed/QbGkDOQE9YU?si=MmCe3OLYjen0etIE",
                            ]}
                        />
                        <ExperienceCard
                            company={"RuckusDev"}
                        ...
                        <ExperienceCard
                            ...
                            videoUrls={[
                                "https://www.youtube.com/embed/mlJCEAxrGio?si=41JNa0dayuPy1guV",
                                "https://www.youtube.com/embed/gxePUMuYZSc?si=b1cjDCINeSUTJPeB",
                                "https://www.youtube.com/embed/Ifs2LI464RE?si=kaLcG6oclmuaoV1m",
                            ]}
                        />
                        <ExperienceCard
                            company={"Framestore"}
                            ...
                            videoUrls={[
                                "https://www.youtube.com/embed/R5aQGuTQI7E?si=IuyrvQjH1FjEN3Qf",
                            ]}
                        />
                        <ExperienceCard
                    ...
                    <div className="flex flex-col lg:flex-row justify-between">
                        <div className="space-y-8 md:space-y-16 mb-16 md:mb-0">
                            ...
                            <p className="font-semibold text-gray-600 text-base">
                                C++ Certificed Associate Programmer{" "}
                            </p>
